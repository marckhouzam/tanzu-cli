...
const (
	...
	// TanzuPluginDiscoveryHostforTanzuContext specifies the custom endpoint path to use with the kubeconfig when talking
	...
	TanzuPluginDiscoveryHostforTanzuContext = "TANZU_CLI_PLUGIN_DISCOVERY_HOST_FOR_TANZU_CONTEXT"
