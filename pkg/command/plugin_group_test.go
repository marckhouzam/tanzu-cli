...
func TestPluginGroupSearch(t *testing.T) {
	...
	// For these tests, we force using the cache.  Normal behaviour
	// does verify the cache validity normally.
